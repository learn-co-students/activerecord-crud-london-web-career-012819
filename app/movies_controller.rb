...
def can_be_found_updated_and_saved
  ...
  original_movie = Movie.find_by(:title => "Awesome Flick")
  original_movie.update(title: "Even Awesomer Flick")
  original_movie.save 
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  original_movie = Movie.create(title: "Wat?")
  original_movie.update(title: "Wat, huh?")
end
